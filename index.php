...
function handle_webhook() {
    ...
    if (isset($input['object']) && $input['object'] === 'page') {
        ...
        echo json_encode(["error" => "Not a page event"]);
    }
}

// Main execution for Vercel
init_database();
